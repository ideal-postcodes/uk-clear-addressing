...
describe("Address Test", function () {
	...
	it ("RULE 1: should return the correct address format", function () {
		sample = {
			postcode: "OX14 4PG",
			post_town: "ABINGDON",
	...
	it ("RULE 2: should return the correct address format", function () {
		sample = {
			postcode: "OX14 4PG",
			post_town: "ABINGDON",
			dependant_locality: "",
	...
	it ("RULE 3: should return the correct address format", function () {
		sample = {
			postcode: "NR25 7HG",
			post_town: "HOLT",
			dependant_locality: "",
	...
	it ("RULE 6: should return the correct address format", function () {
		sample = {
			postcode: "B6 5BA",
